...
syn match crystalTypeDefinition /\%#=1\%(\u\|\\\={{.\{-}}}\)\%(\w\+\|\\\={{.\{-}}}\)*/ contained nextgroup=crystalTypeModule,crystalInheritanceOperator,crystalGeneric skipwhite
...
syn region crystalGeneric matchgroup=crystalDelimiter start=/\%#=1(/ end=/\%#=1)/ contained contains=crystalType nextgroup=crystalInheritanceOperator skipwhite
...
syn region crystalMethodParameters matchgroup=crystalDelimiter start=/\%#=1(/ end=/\%#=1)/ contained contains=crystalVariableOrMethod,crystalInstanceVariable,crystalAnnotation,crystalSplatOperator nextgroup=crystalTypeRestrictionOperator skipwhite
syn match crystalSplatOperator /\%#=1\*\*\=/ contained
...
syn match crystalCFunctionName /\%#=1\%(\h\|\\\={{.\{-}}}\)\%(\w\+\|\\\={{.\{-}}}\)*/ contained nextgroup=crystalCFunctionParameters,crystalTypeRestrictionOperator skipwhite
...
syn region crystalCFunctionParameters matchgroup=crystalDelimiter start=/\%#=1(/ end=/\%#=1)/ contained contains=crystalVariableOrMethod,crystalSplatOperator,crystalAnnotation,@crystalTypes nextgroup=crystalTypeRestrictionOperator skipwhite
...
hi def link crystalSplatOperator crystalOperator
" >>>
