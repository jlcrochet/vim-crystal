...
syn region crystalTernaryOperator matchgroup=crystalOperator start=/\%#=1?/ end=/\%#=1\_s\@1<=:/ skip=/\%#=1:\S/ contained contains=TOP nextgroup=@crystalRHS skipwhite skipempty
...
syn match crystalDelimiter /\%#=1{/ nextgroup=crystalBlockParameters,@crystalArguments skipwhite skipempty
syn match crystalDelimiter /\%#=1}/ nextgroup=@crystalPostfix,crystalOf skipwhite
...
syn match crystalConstant /\%#=1\u[^\x00-\x2F\x3A-\x40\x5B-\x5E`\x7B-\x9F]*/ nextgroup=@crystalPostfix,crystalModuleOperator skipwhite
syn match crystalVariableOrMethod /\%#=1[^\x00-\x5E`\x7B-\x9F][^\x00-\x2F\x3A-\x40\x5B-\x5E`\x7B-\x9F]*[?!]\=/ nextgroup=@crystalPostfix,@crystalArguments,crystalTypeRestrictionOperator skipwhite
...
" Generated by tools/syntax.vim:
syn match crystalNamedTupleKey /\%#=1\u[^\x00-\x2F\x3A-\x40\x5B-\x5E`\x7B-\x9F]*\ze::\@!/ contained nextgroup=crystalNamedTupleKeyDelimiter

syn match crystalNamedTupleKeyDelimiter /\%#=1:/ contained nextgroup=@crystalArguments skipwhite skipempty
...
syn match crystalParameterModifier /\%#=1\*\*\=/ contained nextgroup=crystalVariableOrMethod,crystalInstanceVariable,crystalTypeRestrictionOperator skipwhite
syn match crystalParameterModifier /\%#=1&/ contained nextgroup=crystalVariableOrMethod,crystalInstanceVariable,crystalTypeRestrictionOperator skipwhite
" Generated by tools/syntax.vim:
...
hi def link crystalNamedTupleKeyDelimiter crystalOperator
" >>>
