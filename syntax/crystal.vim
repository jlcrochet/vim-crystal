...
" Generated by tools/syntax.vim:
syn match crystalLibMethodDefinition /\%#=1\%([^\x00-\x5E`\x7B-\x9F]\|{{.\{-}}}\)\%([^\x00-\x2F\x3A-\x40\x5B-\x5E`\x7B-\x9F]\+\|{{.\{-}}}\)*/ contained nextgroup=crystalMethodParameters,crystalTypeRestrictionOperator,crystalMethodAssignmentOperator skipwhite
